    ...
    <div class="row">
        <div class="col-md-12">
            <section class="panel panel-featured">
                ...
                <form action="<?php echo $this->config->item('link_admin_produk_kategori_update').'?id='.$id; ?>" method="post" class="form-horizontal form-bordered">
                    ...
                    <footer class="panel-footer">
                        ...
                        <a type="button" class="btn btn-default" href="<?php echo $this->config->item('link_admin_produk_kategori'); ?>">Batal</a>
                    </footer>
                </form>
            </section>
        </div>
